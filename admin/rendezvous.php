    ...
    try {
        ...
        if ($action === 'add' || $action === 'edit') {
            ...
            if ($action === 'add') {
                ...
                header("Location: rendezvous.php?success=Rendez-vous créé avec succès");
                exit();
                ...
                header("Location: rendezvous.php?success=Rendez-vous modifié avec succès");
                exit();
            }
            ...
            header("Location: rendezvous.php?success=Rendez-vous supprimé avec succès");
            exit();
        }
        ...
        $pdo->rollBack();
        header("Location: rendezvous.php?action=$action&id=$id&error=" . urlencode($e->getMessage()));
        exit();
    }
}
?>
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                $patient = null;
                if ($action === 'edit' && $id) {
                    // CORRECTION : Séparer prepare, execute et fetch
                ...
                <form method="POST" id="rdvForm" novalidate>
                        ...
                        <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">
                                                Code: <?php echo $patient['code_patient']; ?> | 
                                                Tél: <?php echo $patient['telephone']; ?>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <select class="form-select" name="patient_id" required id="patientSelect">
                                ...
                                <option value="<?php echo $p['id']; ?>" 
                                    ...
                                    <?php echo $p['prenom'] . ' ' . $p['nom']; ?> 
                                    (<?php echo $p['code_patient']; ?>)
                                </option>
                                <?php endforeach; ?>
                            </select>
                            <?php endif; ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="docteur_id" required id="docteurSelect">
                                ...
                                <option value="<?php echo $doc['id']; ?>" 
                                    ...
                                    Dr. <?php echo $doc['prenom'] . ' ' . $doc['nom']; ?>
                                    <?php if ($doc['specialite']): ?>
                                    (<?php echo $doc['specialite']; ?>)
                                    <?php endif; ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="motif" rows="3"><?php echo $rdv['motif'] ?? ''; ?></textarea>
                        </div>
                        
                        <div class="col-12">
                            <label class="form-label">Notes</label>
                            <textarea class="form-control" name="notes" rows="2"><?php echo $rdv['notes'] ?? ''; ?></textarea>
                        </div>
                    </div>
                ...
                <form method="GET" class="row g-2" id="filterForm">
                    <div class="col">
                        <input type="text" class="form-control" name="search" 
                               ...
                               value="<?php echo $_GET['search'] ?? ''; ?>" id="searchInput">
                    </div>
                    <div class="col-auto">
                ...
                <tbody>
                    ...
                    <tr class="<?php echo $rowClass; ?>">
                        ...
                        <td>
                            ...
                            <small class="text-muted">
                                <?php echo $rdv['code_patient']; ?><br>
                                <?php echo $rdv['telephone']; ?>
                            </small>
                        </td>
                        <td>
                            <div class="fw-semibold">Dr. <?php echo $rdv['docteur_prenom'] . ' ' . $rdv['docteur_nom']; ?></div>
                            <small class="text-muted"><?php echo $rdv['specialite']; ?></small>
                        </td>
                        <td>
                            <?php 
                                $typeLabels = [
                        ...
                        <td>
                            ...
                            <span title="<?php echo htmlspecialchars($rdv['motif']); ?>">
                                <?php echo substr($rdv['motif'], 0, 30); ?>
