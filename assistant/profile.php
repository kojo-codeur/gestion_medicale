        ...
        <div class="card shadow-sm border-0 mt-4">
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6">
                        <?php
                        // CORRECTION: Gestion sécurisée de la requête
                        $rdvCount = 0;
                        try {
                            $stmt = $pdo->prepare("SELECT COUNT(*) FROM rendez_vous WHERE created_by = ?");
                            if ($stmt) {
                                $stmt->execute([$user_id]);
                                $result = $stmt->fetchColumn();
                                $rdvCount = $result !== false ? (int)$result : 0;
                            }
                        } catch (Exception $e) {
